...
instance MonadStConcreteNames m => MonadStConcreteNames (Strict.ReaderT s m) where
  runStConcreteNames m = Strict.ReaderT $ runStConcreteNames . StateT . flip (Strict.runReaderT . runStateT m)
